          ...
          >
            <SwiperSlide>
              <div className='flex flex-row flex-wrap items-start justify-between'>
                {/* Stage 1 */}
                <div className='basis-full md:basis-[49.5%]'>
                ...
                {/* Stage 2 */}
                <div className='basis-full md:basis-[49.5%] mt-4 md:mt-0'>
                  <div className='presale-card-box rounded-[39px] md:rounded-[59px] bg-[#ffffff] pt-[25px] px-[23px] pb-[50px]'>
                    <div className='flex flex-row flex-nowrap items-center justify-between mb-6'>
                      <div className='basis-1/2 flex justify-start'>
                      ...
                      <div className='basis-1/2 flex justify-end'>
                        <button className='btn inline-block text-[16px] lg:text-[18px] rounded-[30px] text-[#36343C] hover:text-[#ffffff] bg-[#D2B8E3] transition-all pt-[12px] px-[20px] pb-[13px] lg:pt-[10px] lg:px-[20px] lg:pb-[12px] min-w-[75px] min-w-[110px] disabled' href="#">Live</button>
                      </div>
                    </div>
                    <div className='progress-bar mb-8'>
